      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow-sm rounded-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">3.3 Preference Cookies</h3>
            <p className="text-gray-600 mb-4">
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  ...
                  <tr className="border-b">
                    ...
                    <td className="py-2">
                      <a href="https://clerk.com/privacy" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
                  ...
                  <tr>
                    ...
                    <td className="py-2">
                      <a href="https://www.digitalocean.com/legal/privacy-policy" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">4. Managing Your Cookie Preferences</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">4.2 Our Consent Banner</h3>
            <p className="text-gray-600 mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">4.3 Changing Your Consent</h3>
            <p className="text-gray-600 mb-4">
              You can change your cookie preferences at any time by:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li>Clearing your browser cookies and refreshing the page</li>
              <li>Submitting a request via our <a href="/data-rights" className="underline">Data Rights form</a></li>
              <li>Using the browser settings mentioned above</li>
            </ul>
            
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">5. Impact of Disabling Cookies</h2>
            <p className="text-gray-600 mb-4">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              ...
              <li><strong>Preference Cookies:</strong> Your settings won't be remembered between visits</li>
            </ul>
            
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">6. Cookie Consent and GDPR</h2>
            <p className="text-gray-600 mb-4">
            ...
            <p className="text-gray-600 mb-4">
              Our consent banner complies with these requirements by providing clear options and information.
            </p>
            
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">7. Updates to This Policy</h2>
            <p className="text-gray-600 mb-4">
            ...
            <p className="text-gray-600 mb-4">
              For cookie-related questions, please use our <a href="/data-rights" className="underline">Data Rights form</a> or see our <a href="/privacy" className="underline">Privacy Policy</a>.
            </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-8">
              ...
              <ul className="list-disc pl-6 text-blue-800">
                <li>Clear your browser cookies and refresh the page to see the consent banner again</li>
