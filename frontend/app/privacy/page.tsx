      ...
      <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white shadow-sm rounded-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">2.3 Google Analytics Data</h3>
            <p className="text-gray-600 mb-4">
            ...
            <p className="text-gray-600 mb-4">
              <strong>Important:</strong> Google Analytics data is collected only after you provide explicit consent. You can withdraw consent at any time.
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li><strong>Service Provision:</strong> To provide, maintain, and improve our PDF sharing and analytics services</li>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li><strong>Consent:</strong> For analytics and marketing purposes (you can withdraw at any time)</li>
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">5. Data Sharing and Third Parties</h2>
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">5.3 Legal Requirements</h3>
            <p className="text-gray-600 mb-4">
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              ...
              <li><strong>PDF Files:</strong> Until you delete them or your account is deleted</li>
              <li><strong>Analytics Data:</strong> 26 months (Google Analytics default), automatically deleted</li>
              <li><strong>Session Data:</strong> 30 days, automatically deleted</li>
              <li><strong>Email Captures:</strong> 12 months, automatically deleted</li>
              <li><strong>Log Data:</strong> 30 days for security and debugging purposes</li>
              <li><strong>Orphaned Files:</strong> 90 days after user deletion, automatically cleaned up</li>
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">8. Your Rights Under GDPR</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">9. How to Exercise Your Rights</h2>
            <p className="text-gray-600 mb-4">
              You can exercise your rights in several ways:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li><strong>Online Form:</strong> Use our <a href="/data-rights" className="text-blue-600 hover:underline">Data Rights Request Form</a> to:
                <ul className="list-disc pl-6 mt-2">
                  <li><strong>Access your data:</strong> Get a complete copy of all personal data we hold about you</li>
                  <li><strong>Rectify your data:</strong> Update your profile information (name, email)</li>
                  <li><strong>Delete your data:</strong> Permanently delete your account and all associated data</li>
                  <li><strong>Export your data:</strong> Download your data in machine-readable format</li>
                </ul>
              </li>
              <li>Use our <a href="/data-rights" className="text-blue-600 hover:underline">Data Rights Request Form</a></li>
              <li><strong>Postal Address:</strong> [Your Business Address]</li>
            </ul>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">11. Cookies and Tracking Technologies</h2>
            <p className="text-gray-600 mb-4">
              We use cookies and similar technologies for:
            </p>
            <ul className="list-disc pl-6 text-gray-600 mb-4">
              <li><strong>Essential Cookies:</strong> Required for basic site functionality</li>
              <li><strong>Analytics Cookies:</strong> Google Analytics (with consent)</li>
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">15. Supervisory Authority</h2>
            <p className="text-gray-600 mb-4">
              If you are in the EEA and have concerns about our data processing, you have the right to lodge a complaint with your local data protection authority. You can find your authority's contact information at: <a href="https://edpb.europa.eu/about-edpb/board/members_en" className="text-blue-600 hover:underline">https://edpb.europa.eu/about-edpb/board/members_en</a>
            </p>
          </div>
        </div>
      </div>
