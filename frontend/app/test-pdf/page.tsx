...
export default function TestPDFPage() {
  ...
  // Test PDF URL - a simple public PDF
          ...
          <div className="mb-4">
            <div className="flex space-x-2 mb-4">
              <button
                ...
                className={`px-3 py-1 rounded ${currentPdf === "mozilla" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
              >
                Mozilla PDF
              </button>
              <button
                onClick={() => setCurrentPdf("base64")}
                className={`px-3 py-1 rounded ${currentPdf === "base64" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
              >
                Base64 PDF
              </button>
            </div>
            ...
            <p className="text-gray-600 mb-2">
              Testing PDF loading with: <code className="bg-gray-100 px-2 py-1 rounded">
