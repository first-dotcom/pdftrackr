...
export default function DemoFilePage() {
  ...
  // Get the demo file data
  const fileData = demoFiles[slug as keyof typeof demoFiles];
  
  // Build mock share links
  ...
  // Build mock aggregate analytics
  ...
  // Build mock individual sessions
