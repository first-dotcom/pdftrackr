...
import { Clock, Cloud, Database, HardDrive, MessageCircle, Shield, Users } from "lucide-react";
...
export default function AdminPage() {
  const [activeTab, setActiveTab] = useState<"users" | "waitlist" | "feedback">("users");
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        {feedback.map((entry) => (
                          <tr key={entry.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <span
                                className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getCategoryBadgeColor(
                                  entry.category,
                                )}`}
                              >
