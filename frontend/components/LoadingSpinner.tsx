  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 sm:p-8 bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 shadow-sm">
      <div className="relative">
        ...
        <div className={`absolute inset-1 rounded-full border-2 border-transparent border-b-primary-400 border-l-primary-300 animate-spin`} style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
        
        {/* Center dot */}
        <div className={`absolute inset-2 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 shadow-sm`}></div>
      </div>
