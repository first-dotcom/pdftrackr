    ...
    return [
      {
        ...
        headers: [
          ...
          value: "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' cdn.clerk.com *.clerk.accounts.dev *.clerk.dev clerk.pdftrackr.com accounts.pdftrackr.com challenges.cloudflare.com; style-src 'self' 'unsafe-inline' fonts.googleapis.com; font-src 'self' fonts.gstatic.com; img-src 'self' data: cdn.clerk.com *.clerk.accounts.dev img.clerk.com https://*.digitaloceanspaces.com; connect-src 'self' api.clerk.dev *.clerk.accounts.dev clerk.pdftrackr.com accounts.pdftrackr.com clkmail.pdftrackr.com localhost:3001 https://mozilla.github.io https://*.digitaloceanspaces.com; frame-src challenges.cloudflare.com; worker-src 'self' blob:;",
        },
        ],
      },
    ];
